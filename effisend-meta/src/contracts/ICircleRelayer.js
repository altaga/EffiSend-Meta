export const abiCircleRelayer = [
  ...
  {
    inputs: [
      {internalType: 'contract IERC20Metadata', name: 'token', type: 'address'},
    ],
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'contract ICircleIntegration', name: '', type: 'address'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'bytes32', name: 'targetRecipientWallet', type: 'bytes32'},
    ],
